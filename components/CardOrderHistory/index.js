...
const CardOrderHistory = ({ photoURL, name, price, restaurant, id }) => {
  ...
  return (
    <View
      className=" w-full h-[100]  flex-row items-center rounded-3xl bg-white px-3"
      style={{
        backgroundColor: "#fff",
    ...
    >
      ...
      <View className="flex-row items-center flex-grow gap-x-2">
        ...
        <View style={{ width: widthScreen * 0.3 }}>
          {/* Dishes name */}
          <Text
            className="font-[BentonSans-Medium]  text-ellipsis"
            numberOfLines={1}
          >
            {name}
          </Text>
      ...
      >
        <Text className="text-xs text-white font-[BentonSans-Medium]">
          Buy Again
        </Text>
      </TouchableOpacity>
    </View>
