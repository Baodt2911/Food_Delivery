        ...
        <SafeAreaView className='flex-1'>
            <KeyboardAvoidingView className='flex-1' behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
                <ImageBackground className='flex-1 bg-white' source={Pattern} resizeMode='cover'>
                    ...
                    <View className='mx-5'>
                        {/* Verifi SMS */}
                        <TouchableOpacity onPress={() => navigation.navigate('Verification', { sendTo: '0987654321' })}
                        ...
                        {/* Verifi Email */}
                        <TouchableOpacity onPress={() => navigation.navigate('Verification', { sendTo: 'baodt2911@gmail.com' })}
